...
void tet_mesh::checkintegrity() {
	...
	vf1(0,0)=1; vf1(0,2)=1; vf1(0,1)=3;
	vf1(1,0)=1; vf1(1,2)=1; vf1(1,1)=2;
	vf1(2,0)=1; vf1(2,2)=1; vf1(2,1)=3;
	vf1(3,0)=1; vf1(3,2)=1; vf1(3,1)=1;
	TinyMatrix<int,4,3> vf2;
	vf2(0,0)=1; vf2(0,1)=1; vf2(0,2)=3;
	vf2(1,0)=1; vf2(1,1)=1; vf2(1,2)=2;
	vf2(2,0)=1; vf2(2,1)=1; vf2(2,2)=3;
	vf2(3,0)=1; vf2(3,1)=1; vf2(3,2)=1; 
	
	// segments of each face on a tet
	TinyMatrix<int,4,3> sf1;
	sf1(0,0)=1; sf1(0,2)=1; sf1(0,1)=2;
	sf1(1,0)=1; sf1(1,2)=1; sf1(1,1)=5;
	sf1(2,0)=1; sf1(2,2)=1; sf1(2,1)=3;
	sf1(3,0)=1; sf1(3,2)=1; sf1(3,1)=4;
	TinyMatrix<int,4,3> sf2;
	sf2(0,0)=1; sf2(0,1)=1; sf2(0,2)=2;
	sf2(1,0)=1; sf2(1,1)=1; sf2(1,2)=5;
	sf2(2,0)=1; sf2(2,1)=1; sf2(2,2)=3;
	sf2(3,0)=1; sf2(3,1)=1; sf2(3,2)=4;
