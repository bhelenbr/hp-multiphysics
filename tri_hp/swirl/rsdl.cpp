...
void tri_hp_swirl::element_rsdl(int tind, int stage, Array<TinyVector<FLT,MXTM>,1> &uht,Array<TinyVector<FLT,MXTM>,1> &lf_re,Array<TinyVector<FLT,MXTM>,1> &lf_im) {
	int i,j,n;
	FLT fluxx,fluxy;
	TinyVector<int,3> v;
...
#define                 viscI1II0II1II0I visc(0,1)(0,1)
			...
			for (n=0;n<NV-1;++n)
				basis::tri(log2p)->intgrtrs(&lf_re(n)(0),&e(n,0)(0,0),&e(n,1)(0,0),MXGP);
