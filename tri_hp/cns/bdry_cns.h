...
namespace bdry_cns {
	...
	class inflow : public neumann {        
		...
		public:
			inflow(tri_hp_cns &xin, edge_bdry &bin) : neumann(xin,bin) {mytype = "inflow";}
			inflow(const inflow& inbdry, tri_hp_cns &xin, edge_bdry &bin) : neumann(inbdry,xin,bin) {}
