...
init_bdry_cndtn *tri_hp_cns::getnewibc(std::string suffix, input_map& inmap) {
...
//			break;
//		}
//		case ibc_cns::ibc_type::impinge: {
//			temp = new ibc_cns::impinge;
//			break;
//		}
//		case ibc_cns::ibc_type::stokes_drop_gas: {
//			temp = new ibc_cns::stokes_drop_gas;
//			break;
//		}
//		case ibc_cns::ibc_type::stokes_drop_liquid: {
//			temp = new ibc_cns::stokes_drop_liquid;
//			break;
//		}
		default: {
...
tri_hp_helper *tri_hp_cns::getnewhelper(input_map& inmap) {
	...
	switch(type) {
//		case ibc_cns::helper_type::translating_drop: {
//			tri_hp_helper *temp = new ibc_cns::translating_drop(*this);
//			return(temp);
//		}
//		case ibc_cns::helper_type::parameter_changer: {
//			tri_hp_helper *temp = new ibc_cns::parameter_changer(*this);
//			return(temp);
//		}
//		case ibc_cns::helper_type::unsteady_body_force: {
//			tri_hp_helper *temp = new ibc_cns::unsteady_body_force(*this);
//			return(temp);
//		}
//		case ibc_cns::helper_type::force_coupling: {
//			tri_hp_helper *temp = new ibc_cns::force_coupling(*this);
//			return(temp);
//		}
		default: {
