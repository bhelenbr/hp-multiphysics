...
void surface::setup_preconditioner() {
    ...
    for(indx=0;indx<base.nseg+1;++indx) {    
        ...
        jcbi = 1.0/(gbl->vdt(indx)(0,0)*gbl->vdt(indx)(1,1) 
                      -gbl->vdt(indx)(0,1)*gbl->vdt(indx)(1,0));
    ...
    if (basis::tri(x.log2p).sm > 0) {
        for(indx=0;indx<base.nseg;++indx) {
            ...
            jcbi = 1.0/(gbl->sdt(indx)(0,0)*gbl->sdt(indx)(1,1)
                          -gbl->sdt(indx)(0,1)*gbl->sdt(indx)(1,0));
