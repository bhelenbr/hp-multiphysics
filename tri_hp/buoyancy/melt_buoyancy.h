...
namespace bdry_buoyancy {	
	class surface_marangoni : public bdry_ins::surface2 {
		public:
			...
			surface_marangoni(const surface_marangoni& inbdry, tri_hp_ins &xin, edge_bdry &bin)  : bdry_ins::surface2(inbdry,xin,bin), fluxes(inbdry.fluxes), sigma_vs_T(inbdry.sigma_vs_T) {}
