...
//fix temp entire routine
void tet_hp_cns::length() {
		...
		for(int i=0;i<lgpx;++i) {
			for(int j=0;j<lgpy;++j) {
				for(int k=0;k<lgpz;++k) {
					...
					bernoulli += hp_cns_explicit_gbl->mu*(fabs(dudx)+fabs(dudy)+fabs(dudz)+fabs(dvdx)+fabs(dvdy)+fabs(dvdz)+fabs(dwdx)+fabs(dwdy)+fabs(dwdz))/jcb;
					
					dbernoulli = gbl->rho*(ul(0)(i)(j)(k)*ul(0)(i)(j)(k) +ul(1)(i)(j)(k)*ul(1)(i)(j)(k)+ul(2)(i)(j)(k)*ul(2)(i)(j)(k)) +ul(NV-1)(i)(j)(k);	
					dbernoulli += hp_cns_explicit_gbl->mu*(fabs(dudxl)+fabs(dudyl)+fabs(dudzl)+fabs(dvdxl)+fabs(dvdyl)+fabs(dvdzl)+fabs(dwdxl)+fabs(dwdyl)+fabs(dwdzl))/jcb;
