...
tet_hp_helper *tet_hp_cns::getnewhelper(std::string helpername) {
	std::string keyword,movername;
	int type;
	
	type = ibc_cns::helper_type::getid(helpername.c_str());
	switch(type) {
...
init_bdry_cndtn *tet_hp_cns::getnewibc(std::string name) {
