			...
			if (gbl->beta(stage) > 0.0) {
				...
				for(i=0;i<lgpx;++i) {
						...
						for(k=0;k<lgpz;++k) {
							...
							du(2,0)(i)(j)(k) = -d(0)(0)*tres(0)-d(1)(0)*tres(1)-d(2)(0)*tres(2);
							du(2,1)(i)(j)(k) = -d(0)(1)*tres(0)-d(1)(1)*tres(1)-d(2)(1)*tres(2);					
							du(2,2)(i)(j)(k) = -d(0)(2)*tres(0)-d(1)(2)*tres(1)-d(2)(2)*tres(2);
						}
