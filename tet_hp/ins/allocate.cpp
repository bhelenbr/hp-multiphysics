...
//							for(n=0;n<ND;++n) {
//								dcrd(n)(0)(i)(j)(k) = 0.5*(vrtxbd(1)(tet(tind).pnt(1))(n) -vrtxbd(1)(tet(tind).pnt(0))(n));
//								dcrd(n)(1)(i)(j)(k) = 0.5*(vrtxbd(1)(tet(tind).pnt(2))(n) -vrtxbd(1)(tet(tind).pnt(0))(n));
//								dcrd(n)(2)(i)(j)(k) = 0.5*(vrtxbd(1)(tet(tind).pnt(3))(n) -vrtxbd(1)(tet(tind).pnt(0))(n));
//
//							}
//						}
//                    }
...
//
//            for(i=0;i<basis::tet(log2p).gpx;++i) { //temporary fix
//                for(j=0;j<basis::tet(log2p).gpy;++j) {    
//					for(k=0;k<basis::tet(log2p).gpz;++k) {    
//						//cjcb(i)(j)(k) = -gbl->bd(0)*gbl->rho*RAD(crd(0)(i)(j)(k))//fix*(dcrd(0,0)(i,j)*dcrd(1,1)(i,j) -dcrd(1,0)(i,j)*dcrd(0,1)(i,j));
//						for(n=1;n<NV;++n)
