...
void tet_hp::updatepdata(int v0) {
	int n,tind,step; 
	FLT r,s;      
...
void tet_hp::updatepdata_bdry(int bnum, int bel, int endpt) {
...
void tet_hp::movepdata(int from, int to) {
	int n,step;
...
void tet_hp::updatesdata(int sind) {
...
void tet_hp::updatesdata_bdry(int bnum,int bel) {
...
void tet_hp::movesdata(int from, int to) {
	int step;
...
void tet_hp::updatetdata(int tind) {
...
void tet_hp::movetdata(int from, int to) {
	int step;
