...
data0 = np.loadtxt(f"{base_dir}/log2p0/cnvg.dat", delimiter=" ", skiprows=1);
data1 = np.loadtxt(f"{base_dir}/log2p1/cnvg.dat", delimiter=" ", skiprows=1);
data2 = np.loadtxt(f"{base_dir}/log2p2/cnvg.dat", delimiter=" ", skiprows=1);
