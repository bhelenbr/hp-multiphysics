...
errors0 = numpy.loadtxt("Results/cnvg_curved0.dat", delimiter=" ", skiprows=0);
errors1 = numpy.loadtxt("Results/cnvg_curved1.dat", delimiter=" ", skiprows=0);
errors2 = numpy.loadtxt("Results/cnvg_curved2.dat", delimiter=" ", skiprows=0);
...
plt.xlabel('Resolution')
plt.ylabel('Error')
plt.savefig("Results/Curved_Error.pdf")
plt.close()	
