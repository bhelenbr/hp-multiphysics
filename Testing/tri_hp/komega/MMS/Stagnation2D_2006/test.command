...
# 2D turbulent planar stagnation flow used to test k-ln(omg)2006 model with turbulence sustaining terms turned on and stress limiter turned on (i.e. Clim = 7.0/8.0)
