#!/bin/bash
# Runs a case with a communication boundary in the middle
# final solution should be a linear temperature gradient (continuous)
# used to check communication boundaries.
